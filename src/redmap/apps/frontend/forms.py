...
from redmap.apps.redmapdb.models import FBGroup, Sighting, Species, Activity, Accuracy, \
...
class AddStep1(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["other_species"].help_text = "Please use format: 'Latin name (common name)'"
        ...
        if request:
            ...
            # append to the existing uuids session list; else, create a new list in the session for uuids
