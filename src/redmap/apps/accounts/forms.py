...
from redmap.apps.redmapdb.models import Person
...
# TODO: Person (the form) should be renamed to PersonForm to avoid name
# conflict with the Person model.
...
class Person(ModelForm):
    ...
    fieldsets = {
        ...
        'scientist_fields': ('website', 'facebook_url', 'twitter_url', 'linkedin_url'),
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        # remove the is_available field for non admins and non scientist
    ...
    def save(self, commit=True):
        ...
        # is_available is not displayed to users
...
class RegionRadioFieldRenderer(RadioFieldRenderer):
    def __init__(self, name, value, attrs, choices):
        ...
        super(RegionRadioFieldRenderer, self).__init__(name, value, attrs, choices)
