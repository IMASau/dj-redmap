...
# Not using RealTimeSearchIndex for Person since users could
# trigger a DoS by saving repeatedly.  It will get updated with
# cron based index refreshes.
...
# Note: disabling user search temporarily in the home of improving search
#       performance.  Once Whoosh is replaced we can re-enable this.
#
