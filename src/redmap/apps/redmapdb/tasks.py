...
from redmap.apps.redmapdb.models import Region, SightingTracking
...
def get_stale_sightings():
    ...
    for tracking in trackings:
        ...
        # TODO: shouldn't embed email rendering here.
        #       also shouldn't be referring to templates in backend app
        ...
        dictionary = {
            ...
            'image': image,
            # TODO: When sighting region is stored against the sighting (pending db change), pull region data from there
